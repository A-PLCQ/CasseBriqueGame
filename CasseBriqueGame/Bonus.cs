    ...
    class Bonus
    {
        ...
        public void AvoirBonus(ref int nbParties, ref bool accrocheBonus)
        {
            ...
            if (num == 1)
            {
                ...
                // Vérifie que le plateau est plus petit que 100 avant de l'agrandir
            ...
            if (num == 3)
            {
                // Vérifie que le plateau est supérieur à 20 pixels pour ne pas le faire disparaître
            ...
            //Ajout du bonus de vitesse de la boule
            if(num == 6)
            {
